  ...
  return (
    <div className='2xl:w-[1200px] w-[100%] mx-auto'>
       <div className='w-full flex justify-between items-center p-8 py-8 '>
        <h2 className='text-xl font-semibold'>{props.mainData}</h2> <button onClick={handleToggle} className='text-2xl mr-10 outline-none'><i className={`fa-solid fa-angle-${isOpen ? 'down' : 'up'}`}></i></button>
       </div>
