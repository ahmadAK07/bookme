...
const Services = (props) => {
  ...
  return (
    <div className='2xl:w-[1200px] w-[100%] mx-auto'>
       ...
       <div style={{maxHeight: `${isOpen ? "2800px" : '0px'}`}} className={` px-4 pt-4 gap-y-1 flex overflow-hidden w-full flex-wrap lg:justify-start justify-between transition-max-height `}>
